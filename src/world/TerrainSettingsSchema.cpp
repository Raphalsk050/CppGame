...
constexpr FloatField kFloatFields[] = {
    {"Chao e mar", "groundLevel", "altura do chao",
     &TerrainSettings::groundLevel, 0.0f, 260.0f},
    {"Chao e mar", "seaLevel", "nivel do mar", &TerrainSettings::seaLevel,
     0.0f, 200.0f},

    {"Detalhe fino", "detailHeight", "amplitude",
     &TerrainSettings::detailHeight, 0.0f, 16.0f},
    {"Detalhe fino", "detailScale", "frequencia",
     &TerrainSettings::detailScale, 0.005f, 0.30f},
    {"Detalhe fino", "detailSlopeGain", "ganho na encosta",
     &TerrainSettings::detailSlopeGain, 0.0f, 6.0f},
    {"Detalhe fino", "overhangStrength", "saliencias (3D)",
     &TerrainSettings::overhangStrength, 0.0f, 30.0f},
    {"Detalhe fino", "overhangScale", "frequencia das saliencias",
     &TerrainSettings::overhangScale, 0.005f, 0.20f},
    ...
    {"Montanhas", "mountainHeight", "amplitude",
     &TerrainSettings::mountainHeight, 0.0f, 400.0f},
    ...
    {"Cavernas", "waterTableLevel", "lencol freatico (y)",
     &TerrainSettings::waterTableLevel, -50.0f, 200.0f},
    {"Cavernas", "vadoseVerticalStretch", "alongamento vertical",
     &TerrainSettings::vadoseVerticalStretch, 1.0f, 8.0f},
    {"Cavernas", "chamberStrength", "camaras",
     &TerrainSettings::chamberStrength, 0.0f, 5.0f},
    {"Cavernas", "chamberScale", "escala das camaras",
     &TerrainSettings::chamberScale, 0.002f, 0.06f},
    {"Cavernas", "chamberThreshold", "limiar das camaras",
     &TerrainSettings::chamberThreshold, 0.0f, 0.9f},
    {"Cavernas", "chamberMinDepth", "profundidade das camaras",
     &TerrainSettings::chamberMinDepth, 0.0f, 150.0f},

    {"Clima", "climateVerticalExaggeration", "exagero vertical",
     &TerrainSettings::climateVerticalExaggeration, 1.0f, 40.0f},
    {"Clima", "seaLevelTemperature", "temp. no nivel do mar (C)",
     &TerrainSettings::seaLevelTemperature, -10.0f, 40.0f},
    {"Clima", "temperatureVariation", "variacao regional (C)",
     &TerrainSettings::temperatureVariation, 0.0f, 30.0f},
    {"Clima", "basePrecipitation", "chuva base (cm/ano)",
     &TerrainSettings::basePrecipitation, 0.0f, 300.0f},
    {"Clima", "orographicStrength", "sombra de chuva",
     &TerrainSettings::orographicStrength, 0.0f, 1.0f},
    ...
    {"Cores por altitude", "grassHeight", "vegetacao ate",
     &TerrainSettings::grassHeight, 0.0f, 120.0f},
